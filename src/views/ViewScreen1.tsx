...
export const ViewScreen1 = (props) => {
    ...
    const loadViewer = (svfUrl: string) => {
        ...
        //urn = 'URN=dXJuOmFkc2sud2lwcHJvZDpmcy5maWxlOnZmLjJKR0FLWi1mUzQta21SQ3pmaTUwR2c/dmVyc2lvbj0x';
    ...
    //{/* {loadViewerLibrary?<Script url={'js/ForgeViewer.js'} onLoad={carga2}></Script>:null} */}
    ...
    return (
        <>
            <div className="card" id="forgeViewer" style={{ height: window.innerHeight - 380 -18, width: '100%', background: 'rgba(107, 97, 103, 0.466)' }}></div>
